...
| `lib/vertex-ai-oauth-server.js` | Server-only. Authorization Code Flow, token refresh/revoke, GCP project listing. No Firebase dependency. |
...
| `lib/vertex-ai-oauth-server.js` | 서버 전용. Authorization Code Flow, 토큰 갱신/폐기, GCP 프로젝트 목록 조회. Firebase 의존성 없음. |
